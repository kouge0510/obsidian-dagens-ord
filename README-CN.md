...
- **卡片位置可切换**：每日单词卡片可以显示在右侧栏，也可以作为可拖动浮动卡片显示在编辑区上方
...
- 在设置 → **Card display location** 中选择 **Right sidebar** 或 **Editor floating card**
- 使用浮动卡片模式时，可以拖动卡片到喜欢的位置；点击 **Hide** 会折叠为小的 **Open** 按钮，再点击 **Open** 可恢复显示
- 单词播放按钮：播放丹麦语发音
