...
export class DagensOrdCardRenderer {
	private audio: HTMLAudioElement | null = null;
	private wheelScrollCleanup: (() => void) | null = null;

	constructor(
		private plugin: DagensOrdPlugin,
		private requestRender: () => void,
	) {}

	render(container: HTMLElement, renderExtraControls?: (card: HTMLElement) => void): void {
		container.empty();
		...
		if (renderExtraControls) renderExtraControls(card);
